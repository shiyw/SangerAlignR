...
<<chromatogram3, echo=FALSE, fig.pos="h", fig.height=1.6, fig.width=9.5>>=
chromatogram(inputdata(), showcalls="both", trim3=input$trim3, 
...
<<chromatogram4, echo=FALSE, fig.pos="h", fig.height=1.6, fig.width=9.5>>=
chromatogram(inputdata(), showcalls="both", trim3=input$trim3, 
...
<<chromatogram5, echo=FALSE, fig.pos="h", fig.height=1.6, fig.width=9.5>>=
chromatogram(inputdata(), showcalls="both", trim3=input$trim3, 
